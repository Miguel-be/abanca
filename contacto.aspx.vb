Public Class contacto
    ...
    Protected Sub btnenviar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnenviar.Click
        ...
        If noerrores_formulario() Then
            If v.enviar_trabajo(contenido) = 1 Then
    ...
    Private Sub recoger_contenido(ByVal contenido() As String)
        ...
        contenido(1) = txttelefono.Text
        contenido(2) = listexperiencia.SelectedValue
        contenido(3) = listadisponibilidad.SelectedValue
    End Sub
